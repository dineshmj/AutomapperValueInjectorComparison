...
using Architecture.Experiments.AmViComp.Mappers.ValueInjector.Conventions;
...
namespace Architecture.Experiments.AmViComp.Mappers.Abstractions
{
	...
	public abstract class ValueInjecterMapperBase<TFromEntity, TToEntity>
		: MapperBase<TFromEntity, TToEntity>
	{
			...
			)
		{
			...
			// Map the source to the destination using AutoMapper.
			// Mapper.AddMap<TFromEntity, TToEntity>((f, t) => { return (t); });
			enrichThisInstance.InjectFrom (new Model2EntityLoopInjection (), sourceEntity);
